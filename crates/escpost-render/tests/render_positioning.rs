...
#[test]
fn test_profile_ignores_esc_dollar_after_printable_data() {
    let profile = test_profile();
...
#[test]
fn test_profile_still_applies_esc_dollar_after_a_nonprinting_tab() {
    let profile = test_profile();
...
#[test]
fn test_profile_ignores_negative_esc_backslash() {
    let profile = test_profile();
    let input = [
