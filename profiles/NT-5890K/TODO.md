# NT-5890K qualification TODO

These checks need the reference printer and are intentionally deferred until
it is available again:

- Print the shared qualification receipt once more and compare the complete
...
- Qualify additional post-v1 command families as they are implemented and
